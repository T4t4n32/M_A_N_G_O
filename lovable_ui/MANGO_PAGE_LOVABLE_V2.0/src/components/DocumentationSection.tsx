    ...
    <section id="documentacion" className="py-20 md:py-28 bg-mango-dark relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold"><DecryptedText text="Documentación" speed={40} maxIterations={8} animateOn="view" className="text-white" encryptedClassName="text-accent/40" /></h2>
