  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        <motion.h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight mt-6"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, delay: 0.15 }}
          style={{ textShadow: '0 2px 20px hsl(210 35% 6% / 0.8), 0 0 40px hsl(210 35% 6% / 0.5)' }}
        >
          <span className="text-white">Monitoreo Autónomo de</span>
          <br className="hidden sm:block" />
          <span className="inline-flex items-center gap-2 sm:gap-3 text-[1.65rem] sm:text-5xl md:text-6xl lg:text-7xl font-extrabold">
            <RotatingText
        ...
        >
          <DecryptedText
            text="Sistema institucional de monitoreo ambiental en tiempo real para la protección de manglares y ecosistemas marítimos. Tecnología al servicio de la conservación."
            speed={25}
            maxIterations={14}
            animateOn="view"
