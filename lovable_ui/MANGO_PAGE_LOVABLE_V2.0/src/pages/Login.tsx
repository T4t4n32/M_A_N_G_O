...
import { Lock, Mail, Loader2, AlertCircle, ChevronDown, ChevronUp, Eye, EyeOff } from "lucide-react";
...
export default function Login() {
  ...
  // Session bootstrap: if already authenticated, redirect to dashboard
  useEffect(() => {
    checkAuth()
      .then((res) => {
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-11 h-12 bg-white/[0.05] border-white/[0.1] text-white placeholder:text-white/25 rounded-xl focus:ring-2 focus:ring-[hsl(168,72%,42%)]/30 focus:border-[hsl(168,72%,42%)]/40 transition-all hover:bg-white/[0.07]"
                    disabled={loading}
