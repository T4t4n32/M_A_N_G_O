        ...
        <div className="max-w-md mx-auto mb-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-9 py-2.5 rounded-full bg-card border border-border text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-secondary/40 transition-all"
            />
            {search && (
              <button
                onClick={() => setSearch("")}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {visible.map((doc, i) => {
              ...
              return (
                <div
                  key={`${doc.title}-${i}`}
                  className="bg-card rounded-xl border border-border p-5 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 group"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-1 line-clamp-2">{doc.desc}</p>
                        ...
                        <div className="flex gap-0.5">
                          {doc.files.map((file, j) => (
                            <Button
                              ...
                              size="sm"
                              variant="ghost"
                              className="text-secondary hover:text-secondary/80 gap-1 text-xs h-7 px-2"
                              asChild
                            >
