...
const images = [
  ...
  { src: "/images/gallery/hardware/hardware_61_HELTEC_2.jpg", title: "hardware_61_HELTEC_2", cat: "Hardware", desc: "Módulo Heltec WiFi LoRa 32 con pantalla OLED y cables." },
  { src: "/images/gallery/hardware/hardware_62_HELTEC_3.jpg", title: "hardware_62_HELTEC_3", cat: "Hardware", desc: "PCB Heltec V3 con pantalla OLED en estación de soldadura." },
  { src: "/images/gallery/hardware/hardware_63_HELTEC_4.jpg", title: "hardware_63_HELTEC_4", cat: "Hardware", desc: "Dos módulos Heltec en protoboard con comunicación LoRa activa." },
  { src: "/images/gallery/hardware/hardware_64_HELTEC_WIFI.jpg", title: "hardware_64_HELTEC_WIFI", cat: "Hardware", desc: "Caja Heltec LoRa 32 (433-510 MHz) junto a módulo WiFi." },
  { src: "/images/gallery/hardware/hardware_65_jetson_expansion.jpg", title: "hardware_65_jetson_expansion", cat: "Hardware", desc: "Diagrama de pines GPIO del NVIDIA Jetson TK1 Expansion." },
  { src: "/images/gallery/hardware/hardware_66_Manual_CHINO.jpg", title: "hardware_66_Manual_CHINO", cat: "Hardware", desc: "Manual de instrucciones del electrodo compuesto de pH." },
  { src: "/images/gallery/hardware/hardware_67_MATERIALES.jpg", title: "hardware_67_MATERIALES", cat: "Hardware", desc: "Materiales del proyecto: Raspberry Pi 4, sensores y herramientas." },
  { src: "/images/gallery/hardware/hardware_68_MATERIALES_2.jpg", title: "hardware_68_MATERIALES_2", cat: "Hardware", desc: "Vista de materiales: Jetson TK1, Raspberry Pi 4 y componentes." },
  { src: "/images/gallery/hardware/hardware_69_MATERIALES_3.jpg", title: "hardware_69_MATERIALES_3", cat: "Hardware", desc: "Vista panorámica de todos los materiales del proyecto." },
   { src: "/images/gallery/hardware/hardware_70_MAX31865.jpg", title: "hardware_70_MAX31865", cat: "Hardware", desc: "Módulos MAX31865 para lectura de sensor PT100 de temperatura." },
   { src: "/images/gallery/hardware/hardware_71_MAX31865_1.jpg", title: "hardware_71_MAX31865_1", cat: "Hardware", desc: "MAX31865 - Tarjeta de conversión PT100 (2/3/4 Wire)." },
   { src: "/images/gallery/hardware/hardware_72_MAX31865_2.jpg", title: "hardware_72_MAX31865_2", cat: "Hardware", desc: "MAX31865 - Bornes verdes para conexión de sensores Platinum RTD." },
   { src: "/images/gallery/hardware/hardware_73_MAX31865_3.jpg", title: "hardware_73_MAX31865_3", cat: "Hardware", desc: "MAX31865 - PCB con chip regulador MCP6002 de precisión." },
   { src: "/images/gallery/hardware/hardware_74_MAX31865_4.jpg", title: "hardware_74_MAX31865_4", cat: "Hardware", desc: "MAX31865 - Conectores de tornillo para cables del sensor PT100." },
   { src: "/images/gallery/hardware/hardware_75_MAX31865_5.jpg", title: "hardware_75_MAX31865_5", cat: "Hardware", desc: "MAX31865 - Vista completa con pines SPI (SDO, COS, SAS, NIA)." },
   { src: "/images/gallery/hardware/hardware_76_MONTAJE_1.jpg", title: "hardware_76_MONTAJE_1", cat: "Progreso", desc: "Montaje en banco: Heltec con protoboard y sensores conectados." },
   { src: "/images/gallery/hardware/hardware_77_MONTAJE_2.jpg", title: "hardware_77_MONTAJE_2", cat: "Progreso", desc: "Protoboard con cableado multicolor y módulos de acondicionamiento de señal." },
   { src: "/images/gallery/hardware/hardware_78_MONTAJE_3.jpg", title: "hardware_78_MONTAJE_3", cat: "Progreso", desc: "Integración de componentes: Heltec, regulador y convertidor de nivel en protoboard." },
   { src: "/images/gallery/hardware/hardware_79_MONTAJE_4.jpg", title: "hardware_79_MONTAJE_4", cat: "Progreso", desc: "Detalle de cableado: Sensor de temperatura y módulo ADS1115 conectados." },
   { src: "/images/gallery/hardware/hardware_80_MONTAJE_5.jpg", title: "hardware_80_MONTAJE_5", cat: "Progreso", desc: "Vista de pruebas integradas: MAX31865, ADS1115 y reguladores en funcionamiento." },
   { src: "/images/gallery/hardware/hardware_81_MONTAJE_6.jpg", title: "hardware_81_MONTAJE_6", cat: "Hardware", desc: "Módulo acondicionador de señal con pines y cables de conexión." },
   { src: "/images/gallery/hardware/hardware_82_MONTAJE_7.jpg", title: "hardware_82_MONTAJE_7", cat: "Hardware", desc: "Tarjeta MAX31865 con bornes verdes para sensor PT100 (detalle en mano)." },
   { src: "/images/gallery/hardware/hardware_83_MONTAJE_8.jpg", title: "hardware_83_MONTAJE_8", cat: "Progreso", desc: "Sensor PT100 con cable blindado conectado a módulo MAX31865." },
   { src: "/images/gallery/hardware/hardware_84_MONTAJE_9.jpg", title: "hardware_84_MONTAJE_9", cat: "Progreso", desc: "Cableado de protoboard con conectores para sensores analógicos." },
   { src: "/images/gallery/hardware/hardware_85_MONTAJE_10.jpg", title: "hardware_85_MONTAJE_10", cat: "Progreso", desc: "Convertidor de nivel TXB0104 con pines I2C/SPI conectados al protoboard." },
   { src: "/images/gallery/hardware/hardware_86_MONTAJE_11.jpg", title: "hardware_86_MONTAJE_11", cat: "Hardware", desc: "Arduino UNO con shield y cableado multicolor en protoboard." },
   { src: "/images/gallery/hardware/hardware_87_MONTAJE_12.jpg", title: "hardware_87_MONTAJE_12", cat: "Progreso", desc: "Integración de Arduino con módulos de acondicionamiento en protoboard." },
   { src: "/images/gallery/hardware/hardware_88_MONTAJE_13.jpg", title: "hardware_88_MONTAJE_13", cat: "Progreso", desc: "Detalle de conexión: MAX31865 con sensor y convertidor de nivel." },
   { src: "/images/gallery/hardware/hardware_89_MONTAJE_14.jpg", title: "hardware_89_MONTAJE_14", cat: "Progreso", desc: "Sensor de turbidez AZDM01 conectado a módulo acondicionador." },
   { src: "/images/gallery/hardware/hardware_90_MONTAJE_15.jpg", title: "hardware_90_MONTAJE_15", cat: "Progreso", desc: "Módulo MAX31865 con cable blindado para sensor PT100 en protoboard." },
];
