      ...
      >
        ...
        <div className="text-center space-y-2">
          <a href="/" className="inline-block" aria-label="Volver al inicio">
            <img src={logo} alt="M.A.N.G.O" className="h-28 w-auto mx-auto" />
          </a>
        ...
        <Button asChild variant="outline" className="w-full bg-mango-slate/50 border-border/40 text-secondary-foreground hover:bg-mango-slate hover:text-primary rounded-full font-semibold text-base py-6">
