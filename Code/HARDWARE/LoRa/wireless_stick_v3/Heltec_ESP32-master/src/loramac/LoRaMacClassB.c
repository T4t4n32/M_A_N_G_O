 ...
 */
RTC_DATA_ATTR static BeaconState_t BeaconState;

/*!
 * State of the ping slot mechanism
 */
RTC_DATA_ATTR static PingSlotState_t PingSlotState;

/*!
 * State of the multicast slot mechanism
 */
RTC_DATA_ATTR static PingSlotState_t MulticastSlotState;

/*!
 * Class B ping slot context
 */
RTC_DATA_ATTR static PingSlotContext_t PingSlotCtx;

/*!
 * Class B beacon context
 */
RTC_DATA_ATTR static BeaconContext_t BeaconCtx;

/*!
 * Timer for CLASS B beacon acquisition and tracking.
 */
RTC_DATA_ATTR static TimerEvent_t BeaconTimer;

/*!
 * Timer for CLASS B ping slot timer.
 */
RTC_DATA_ATTR static TimerEvent_t PingSlotTimer;

/*!
 * Timer for CLASS B multicast ping slot timer.
 */
RTC_DATA_ATTR static TimerEvent_t MulticastSlotTimer;

/*!
 * Container for the callbacks related to class b.
 */
RTC_DATA_ATTR static LoRaMacClassBCallback_t LoRaMacClassBCallbacks;

/*!
 * Data structure which holds the parameters which needs to be set
 * in class b operation.
 */
RTC_DATA_ATTR static LoRaMacClassBParams_t LoRaMacClassBParams;
