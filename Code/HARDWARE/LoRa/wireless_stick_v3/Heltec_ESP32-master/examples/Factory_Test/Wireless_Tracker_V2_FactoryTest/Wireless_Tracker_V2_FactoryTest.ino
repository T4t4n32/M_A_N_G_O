...
void enter_deepsleep(void)
{
	...
	rtc_gpio_isolate((gpio_num_t)LORA_PA_POWER);
	...
	while(1)
	{
		if(Serial1.available()>0)
		{
			...
			else
			{
				Serial1.read();
				st7735.st7735_fill_screen(ST7735_BLACK);
				st7735.st7735_write_str(0, 0, (String)"gps_detected");
				...
				st7735.st7735_write_str(0, 15, time_str);
				String latitude = "LAT: " + (String)gps.location.lat();
				st7735.st7735_write_str(0, 30, latitude);
				String longitude  = "LON: "+  (String)gps.location.lng();
				st7735.st7735_write_str(0, 45, longitude);
