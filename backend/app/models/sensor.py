...
class Sensor(db.Model):
    ...
    model = db.Column(db.String(64), nullable=True)  # "GENERIC_PH", "PT100_MAX31865", "AZDM01", "TSW-20M"
...
class SensorData(db.Model):
    ...
    reason = db.Column(db.String(64), nullable=True)   # OUT_OF_RANGE_PH, NOT_A_NUMBER, ...
